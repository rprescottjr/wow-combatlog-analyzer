...
public class ResultsPrinter {
    ...
    public static void displayTitleAndHeaderRow(String title, List<String> columnNames) {
        String headerSurrounder = new StringBuilder()
            .append("+")
            .append(StringUtils.repeat("-", TOTAL_LINE_LENGTH - 2))
            .append("+")
            .toString();
        String titleRow = new StringBuilder()
            .append("|")
            .append(StringUtils.center(title, TOTAL_LINE_LENGTH - 2))
            .append("|")
            .toString();
     ...
     * Example:<br/><br/>
     * <b>ResultsPrinter.displayDataRow(Arrays.asList("Geology", "8", "3");</b> <br/><br/>
     * 
     * |            Geology             |               8                |               3                |
     * 
     * 
