...
public class RuneUsageTracker {
    ...
    /**
     * Given a raw line from a WoW Combat Log, inserts a Dark/Demonic Rune usage event and associates the event to the user of the item.
     * 
    ...
    /**
     * Given a normalized player name, returns the number of Dark Runes + Demonic Runes used by this player. If the provided player name
     * did not use any runes, then 0 is returned.
     * 
     * @param playerName
     *      The normalized player name of interest.
     * @return
     *      The number of Dark Runes + Demonic Runes used by this player, or 0 if the person did not use any.
     */
